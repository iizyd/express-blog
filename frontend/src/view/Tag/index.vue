            ...
            action: 'soft',
				...
				>
					<template #header-extra>
						<n-button type="warning" size="small" @click="resetForm"> 重 置 </n-button>
					</template>
					...
					<template #action>
						<n-space>
							<n-button v-show="isEdit" type="primary" size="small" @click="onUpdate">
								更 新
							</n-button>

							<n-button v-show="!isEdit" type="info" size="small" @click="onCreate">
								创 建
							</n-button>
						</n-space>
					</template>
